  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-[900px] mx-auto px-6 py-14">
        ...
        <div className="prose prose-neutral max-w-none font-body text-[15px] leading-[1.85] space-y-8">
          <section>
            ...
            <p>By accessing or using the Emily Russell Realty website ("Site"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, you may not access or use the Site. These Terms constitute a legally binding agreement between you and Emily Russell Realty ("we," "us," or "our").</p>
          </section>
          ...
          <section>
            ...
            <p>To the fullest extent permitted by applicable law, Emily Russell Realty shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues, whether incurred directly or indirectly, arising out of your use of the Site or reliance on any information provided herein. Our total aggregate liability shall not exceed one hundred dollars ($100).</p>
          </section>

          <section>
            <h2 className="font-display text-xl mb-3">8. Indemnification</h2>
            <p>You agree to indemnify, defend, and hold harmless Emily Russell Realty, its agents, affiliates, and partners from and against any claims, liabilities, damages, losses, and expenses (including reasonable attorneys' fees) arising out of or in any way connected with your access to or use of the Site, or your violation of these Terms.</p>
          </section>
      ...
      <footer className="bg-charcoal text-center py-6 px-6" style={{ color: "rgba(255,255,255,.45)" }}>
        <p className="font-body text-[11px]">© 2026 Emily Russell Realty · <Link to="/privacy" className="hover:text-gold-light transition-colors" style={{ color: "inherit" }}>Privacy Policy</Link> · <Link to="/" className="hover:text-gold-light transition-colors" style={{ color: "inherit" }}>Home</Link></p>
      </footer>
    </div>
  );
}
